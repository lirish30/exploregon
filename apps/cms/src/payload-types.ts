...
export interface Page {
  ...
  route?: {
    legacyType?: ('home' | 'city' | 'region' | 'listing' | 'generic') | null;
    pathPattern?: string | null;
  };
  location?: {
    region?: (number | null) | Page;
    city?: (number | null) | Page;
  ...
  listingDetails?: {
    ...
    sourceType?: ('manual' | 'imported' | 'partner') | null;
  };
  meta?: {
    title?: string | null;
    /**
...
export interface Post {
  ...
  guideDetails?: {
    ...
    relatedCities?: (number | Page)[] | null;
  };
  eventDetails?: {
    venue?: string | null;
...
export interface Category {
  ...
  title: string;
  /**
   * Optional stable icon token for frontend category icon mapping.
   */
  icon?: string | null;
  /**
   * Auto-generated from the title/name if left blank.
...
export interface Redirect {
  id: number;
  /**
   * Rebuild the frontend when changing this field.
   */
  from: string;
  to?: {
    type?: ('reference' | 'custom') | null;
